...
import com.laundry.management.employee.application.EmployeeCodeGenerator;
...
@ActiveProfiles("test")
@SpringBootTest
class EmployeeCodeGeneratorConcurrencyTest {

    @Autowired private EmployeeCodeGenerator codeGenerator;
    @Autowired private TransactionTemplate transactionTemplate;

    @Test
    void concurrentAllocationsRemainGloballyUnique() throws Exception {
        ...
        try {
            ...
            assertThat(codes).allMatch(code -> code.matches("NV-\\d{6,}"));
        } finally {
