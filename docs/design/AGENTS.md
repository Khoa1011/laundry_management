...
When updating Liquid Glass guidance:

- Keep `LIQUID_GLASS_ADMIN_RULES.md` aligned with root `DESIGN.md`.
...
- Preserve mobile-first, Vietnamese operations UI, permission awareness, accessibility, reduced motion, and no-blur fallback requirements.
