...
If a system-wide visual decision changes, update root `DESIGN.md` first. Use files in this folder for supporting guidance, task templates, and implementation checklists only.
